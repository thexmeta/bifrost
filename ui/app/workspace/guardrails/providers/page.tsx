  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Configure guardrails providers like AWS Bedrock Guardrails, Azure
          Content Safety, or Patronus AI to enforce content safety policies.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage guardrails provider configurations
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Add your first guardrails provider to start enforcing content
              safety policies
            </p>
