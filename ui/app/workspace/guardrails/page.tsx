	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Configure content safety guardrails</p>
			</div>

			<Alert>
				<Construction className="h-4 w-4" />
				<AlertDescription>
					Guardrails provide content safety enforcement using AWS Bedrock Guardrails,
					Azure Content Safety, or Patronus AI for real-time content moderation.
				</AlertDescription>
			</Alert>
				...
				<CardContent>
					<div className="flex flex-col items-center justify-center py-12 text-center">
						...
						<p className="mb-4 text-sm text-muted-foreground">
							Create your first guardrail rule to enforce content safety policies
						</p>
