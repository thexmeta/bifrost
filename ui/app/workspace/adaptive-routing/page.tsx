  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Adaptive Routing uses real-time performance metrics and health
          monitoring to intelligently route requests to the best-performing
          providers.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage adaptive load balancing settings
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-lg font-semibold">
              Adaptive Routing Not Configured
            </h3>
            <p className="mb-4 text-sm text-muted-foreground">
              Configure adaptive routing to enable intelligent load balancing
