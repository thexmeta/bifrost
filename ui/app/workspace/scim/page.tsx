    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure SCIM-based user provisioning
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          SCIM (System for Cross-domain Identity Management) enables automated
          user provisioning and deprovisioning from your identity provider.
        </AlertDescription>
      </Alert>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Configure SCIM to enable automated user provisioning from your
              identity provider
            </p>
