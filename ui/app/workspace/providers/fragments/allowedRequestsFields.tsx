...
const ProviderEndpoints: Partial<
  Record<BaseProvider, Partial<Record<RequestType, string>>>
> = {
  openai: {
...
const getPlaceholder = (
  providerType: BaseProvider | undefined,
...
export function AllowedRequestsFields({
  ...
  const isPathOverrideDisabled = useMemo(
    () => providerType === "gemini" || providerType === "bedrock",
    [providerType],
  );

  const renderRequestField = (requestType: {
    key: RequestType;
    label: string;
  }) => {
                        ...
                        >
                          <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground text-xs">
                              Override with a path (e.g., /v1/chat) or a full
                              URL (e.g., https://api.example.com/chat) to bypass
                              base_url
                            </p>
                            <Input
